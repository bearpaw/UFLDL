...
% 
% save('checkparams.mat', 'data', 'stack', 'softmaxTheta');
load('checkparams.mat', 'data', 'stack', 'softmaxTheta');
...
[cost2, grad2] = other_stackedAECost(stackedAETheta, inputSize, hiddenSize, ...
                             numClasses, netconfig, ...
                             lambda, data, labels);
...
numgrad2 = computeNumericalGradient( @(x) other_stackedAECost(x, inputSize, ...
                                        hiddenSize, numClasses, netconfig, ...
                                        lambda, data, labels), ...
                                        stackedAETheta);                                    
...
diff2 = norm(numgrad-grad)/norm(numgrad+grad);
disp(diff); % Should be small. In our implementation, these values are
disp(diff2); % Should be small. In our implementation, these values are
